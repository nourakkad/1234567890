...
const DrMohammedJubain = () => {
  ...
  const doctorInfo = {
    ...
    description: currentLanguage === 'AR' 
      ? "د. محمد جبين هو جراح مسالك بولية ذو خبرة عالية في تشخيص وعلاج أمراض المسالك البولية والجراحات المتقدمة."
      : "Dr. Mohammed Jubain is a highly experienced urological surgeon specializing in the diagnosis and treatment of urological diseases and advanced surgical procedures."
  };
...
export default DrMohammedJubain; 