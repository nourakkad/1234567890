...
const CrazyBeeez = () => {
  ...
  const doctorInfo = {
    title: currentLanguage === 'AR' ? "Crazy Beeez" : "Crazy Beeez",
    category: currentLanguage === 'AR' ? "Be Crazy Be Creative" : "Be Crazy Be Creative",
    ...
    phone: "+963 997 263 261",
    email: "crazybeeezinfo@gmail.com",
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              {currentLanguage === 'AR' ? 'Be Crazy Be Creative' : 'Be Crazy Be Creative'}
            </span>
          </div>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 
          ...
          <div style={{
            ...
            <a
              href="https://forms.gle/MRUGTRNd9xCwQ7qj9"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                backgroundColor: '#ffa700',
