      ...
      <div className="container">
              ...
              <div className="col-lg-6 align-self-center wow fadeInRight order-lg-2 order-1" data-wow-duration="1s" data-wow-delay="0.5s">
                <div className="about-right-content">
                  <div className="section-heading">
                    <h6>About Us</h6>
                    <h4>Who is Elyp<em>tek</em></h4>
                    <div className="line-dec"></div>
                  </div>
                  <p>
                    At Elyptek , we believe that true digital success begins with 
                    a bold idea , grows through smart strategy , and comes to life 
                    through expert execution . We are a creative agency specializing 
                    in digital marketing , website design , and development , helping
                    brands stand out , engage , and thrive in today's fast-paced digital world .
                  </p>
                  <p>
                    Since our launch , we've partnered with clients across 
                    various industries to deliver integrated solutions that 
                    start with building a strong digital identity and extend 
                    to creating impactful websites and result-driven marketing campaigns .
                  </p>
        ...
        <div className="row justify-content-center" style={{marginTop: '40px'}}>
          <div className="col-lg-8 text-center">
            <h5 style={{marginBottom: '24px', color: '#ffa700', fontWeight: '600'}}> Our Services Include : </h5>
            <div className="services-list">
              <div className="service-item">
                <i className="fas fa-users"></i>
                <span>Professional management of <b>Facebook</b> and <b>Instagram</b> pages</span>
              </div>
              <div className="service-item">
                <i className="fas fa-pen-nib"></i>
                <span>Creative content writing and engaging post publishing</span>
              </div>
              <div className="service-item">
                <i className="fas fa-lightbulb"></i>
                <span>Innovative business strategies tailored to your needs</span>
              </div>
              <div className="service-item">
                <i className="fas fa-laptop-code"></i>
                <span>Development of standout websites that reflect your vision</span>
              </div>
              <div className="service-item">
                <i className="fas fa-paint-brush"></i>
                <span>Comprehensive marketing solutions, including posters, brochures, visual identity, logos, and design</span>
              </div>
            </div>
            <p style={{marginTop: '30px', fontSize: '16px', lineHeight: '1.6'}}>
                    We are here to help you grow your brand and achieve your goals .
